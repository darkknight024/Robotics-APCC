...
writematrix(OutputGH,'IRB_1300-1150_Robot_MI_Yoshikawa_800000points.csv');
%Save output file trimmed
OutputGHtrimmed=[wksp_trimmed, MI_Yoshikawa_trimmed];
writematrix(OutputGHtrimmed,'IRB_1300-1150_Robot_MI_Yoshikawa_800000points_Top10Percent.csv');
